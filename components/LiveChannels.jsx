    ...
    return (
        <div id='live' className='p-2 md:p-8'>
            ...
            <div className='grid sm:grid-cols-2 md:grid-cols-3 2xl:grid-cols-4 3xl:grid-cols-5 gap-4 py-2'>
                <LiveChannelItem
                    img={Live1}
                    profile_img='https://static-cdn.jtvnw.net/jtv_user_pictures/8dda9f12-7c23-4813-85e7-e5826234dfa1-profile_image-50x50.png'
                ...
                <LiveChannelItem
                    img={Live2}
                    profile_img='https://static-cdn.jtvnw.net/jtv_user_pictures/aab06f62-2f1d-4f73-b70a-8de0861f946c-profile_image-50x50.jpeg'
                ...
                <LiveChannelItem
                    img={Live7}
                    profile_img='https://static-cdn.jtvnw.net/user-default-pictures-uv/998f01ae-def8-11e9-b95c-784f43822e80-profile_image-50x50.png'
